...
$ReleaseUrl = "https://github.com/exteriya1337/ZapretikApp/releases/download/v1.0.1/ZapretikApp.exe"
$ConfigUrl  = "https://github.com/exteriya1337/ZapretikApp/releases/download/v1.0.1/ZapretikApp.exe.config"
